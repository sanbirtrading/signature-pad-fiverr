ej.base.enableRipple(true);
    ...
    var toolbarObj = new ej.navigations.Toolbar({
        ...
        items: [
            ...
            { type: 'Separator' },
            { text: 'Clear', prefixIcon: 'e-icons e-trash', tooltipText: 'Clear' },
        ...
        created: function(args) {
            ...
            new ej.splitbuttons.SplitButton({content: 'Save', iconCss: 'e-icons e-save', items: items, select: onSelect, disabled: true }, '#save-option');
